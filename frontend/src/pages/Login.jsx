    ...
    <div className="min-h-screen bg-black flex">
      ...
      <div className="flex-1 bg-black flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-[#888] text-sm mt-2 mb-8">Sign in to your CRM dashboard</p>
          ...
          <p className="text-center text-[#888] text-sm mt-6">
            No account?{' '}
            <Link to="/register" className="text-white font-medium hover:text-gray-300 transition-colors">
              Create one
            </Link>
          </p>
        </div>
